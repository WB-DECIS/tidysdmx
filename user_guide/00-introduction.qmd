...
- [FMR client](03-fmr-client.qmd) — talk to a registry behind single sign-on, with token refresh handled for you.

More chapters — end-to-end workflow, SDMX concepts, mapping templates, validation, and LLM/agent artefacts — are in progress and will be linked here as they land.
