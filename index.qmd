...
- **Schema inference from tidy data** — `create_schema_from_table()` builds the schema components (a `SchemaComponents` bundle of DSD, ConceptScheme, and Codelists) directly from a pandas DataFrame, so you can describe your raw input without writing a line of XML.
